...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    key: "collidesWith",
    value: function collidesWith(player, platform) {
...
function init() {
  console.log('init');
  player = new Player();
  platforms = [new Platform(0, 660 - 50, platformImage), new Platform(100, 660 - 50, platformImage), new Platform(200, 660 - 50, platformImage), new Platform(400, 510 - 50, platformImage), new Platform(500, 510 - 50, platformImage), new Platform(600, 510 - 50, platformImage), new Platform(700, 510 - 50, platformImage), new Platform(975, 510 - 50, platformImage), new Platform(1075, 510 - 50, platformImage), new Platform(1175, 510 - 50, platformImage), new Platform(1275, 510 - 50, platformImage), new Platform(1575, 660 - 50, platformImage), new Platform(1675, 660 - 50, platformImage), new Platform(1775, 660 - 50, platformImage)];
...
function animate() {
  ...
  console.log(player.collidesWith(player, platforms));
  platforms.forEach(function (platform) {
    if (player.position.y + player.height <= platform.position.y && player.position.y + player.height + player.velocity.y >= platform.position.y && player.position.x + player.width >= platform.position.x && player.position.x <= platform.position.x + platform.width) {
      player.velocity.y = 0;
      space_pressed = 0;
